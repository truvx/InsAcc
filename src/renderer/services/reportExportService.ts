...
function generatePdfCoverPage(doc: any, title: string, subtitle: string, periodLabel: string, currency: string, totalTxns?: number, moduleName?: string, generatedBy: string = 'User'): number {
  const pageWidth = doc.internal.pageSize.getWidth()
