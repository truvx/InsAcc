...
export const DEFAULT_INVESTMENT_ASSETS: InvestmentAsset[] = [
  ...
  { id: 'ast-silver-9990-coin', categoryId: 'cat-silver', name: '999.0 Silver Coin', unit: 'pcs', active: true, displayOrder: 6 },
  { id: 'ast-silver-999-bar', categoryId: 'cat-silver', name: '999 Silver Bar', unit: 'gram', active: true, displayOrder: 7 },
  { id: 'ast-silver-999-coin', categoryId: 'cat-silver', name: '999 Silver Coin', unit: 'pcs', active: true, displayOrder: 8 },
  { id: 'ast-silver-bullion-1kg', categoryId: 'cat-silver', name: 'Silver Bullion 1kg', unit: 'gram', active: true, displayOrder: 9 },
  { id: 'ast-silver-bullion-5kg', categoryId: 'cat-silver', name: 'Silver Bullion 5kg', unit: 'gram', active: true, displayOrder: 10 },
  { id: 'ast-silver-etf', categoryId: 'cat-silver', name: 'Silver ETF', unit: 'unit', active: true, displayOrder: 11 },
  { id: 'ast-silver-cert', categoryId: 'cat-silver', name: 'Silver Certificate', unit: 'unit', active: true, displayOrder: 12 },
