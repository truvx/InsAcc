      ...
      <div className="page-body">
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '2.1fr 0.9fr', gap: 20, alignItems: 'start', marginBottom: 24 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            {/* Upcoming PDC Alerts */}
            <motion.div
              whileHover={{ y: -3, scale: 1.01, boxShadow: '0 12px 24px rgba(59, 130, 246, 0.08)' }}
              whileTap={{ scale: 0.99 }}
            ...
            >
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                ...
                >
                  <div>
                    <div style={{ fontSize: 11, fontWeight: 700, color: '#3B82F6', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Within 7 Days</div>
                  ...
                  <div style={{ textAlign: 'right' }}>
                    ...
                    <div style={{ fontSize: 14, fontWeight: 700, color: '#2563EB', marginTop: 1 }}>
                ...
                >
                  <div>
                    <div style={{ fontSize: 11, fontWeight: 700, color: '#2563EB', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Within 30 Days</div>
                    <div style={{ fontSize: 15, fontWeight: 700, color: 'var(--text-primary, #1F2937)', marginTop: 2 }}>
                  ...
                  <div style={{ textAlign: 'right' }}>
                    <div style={{ fontSize: 10, color: '#9CA3AF' }}>Total Value</div>
                    <div style={{ fontSize: 14, fontWeight: 700, color: '#1D4ED8', marginTop: 1 }}>
