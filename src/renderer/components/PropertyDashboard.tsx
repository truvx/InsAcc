      ...
      <div className="page-body">
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '2.1fr 0.9fr', gap: 20, alignItems: 'start', marginBottom: 24 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            {/* Upcoming PDC Alerts */}
            <motion.div
              whileHover={{ y: -3, scale: 1.01, boxShadow: '0 12px 24px rgba(222, 141, 169, 0.08)' }}
              whileTap={{ scale: 0.99 }}
              onClick={() => onNavigate?.('pdc-manager')}
              style={{
              ...
              onMouseEnter={e => {
                e.currentTarget.style.borderColor = '#DE8DA9'
              }}
              onMouseLeave={e => {
            ...
            >
              <div style={{
                ...
                right: 0,
                height: 4,
                background: 'linear-gradient(90deg, #DE8DA9, #F2BACB)',
              }} />
              ...
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 18 }}>
                <div style={{ display: 'flex', alignItems: 'center' }}>
                  <div style={{
                    width: 32, height: 32,
                    borderRadius: 8,
                    background: 'rgba(222, 141, 169, 0.1)',
                  ...
                  <span style={{ fontWeight: 700, fontSize: 15, color: 'var(--text-primary, #1F2937)', letterSpacing: '-0.01em' }}>Upcoming PDC Alerts</span>
                </div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                <div style={{
                  ...
                  padding: '12px 14px',
                  background: 'rgba(222, 141, 169, 0.03)',
                  border: '1px solid rgba(222, 141, 169, 0.1)',
                  borderRadius: 10,
                  transition: 'background 0.2s',
                }}
                onMouseEnter={e => { e.currentTarget.style.background = 'rgba(222, 141, 169, 0.06)' }}
                onMouseLeave={e => { e.currentTarget.style.background = 'rgba(222, 141, 169, 0.03)' }}
                >
                  <div>
                    <div style={{ fontSize: 11, fontWeight: 700, color: '#DE8DA9', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Within 7 Days</div>
                    <div style={{ fontSize: 15, fontWeight: 700, color: 'var(--text-primary, #1F2937)', marginTop: 2 }}>
                      {pdcStats.next7DaysCount} {pdcStats.next7DaysCount === 1 ? 'Cheque' : 'Cheques'}
                    </div>
                  </div>
                  <div style={{ textAlign: 'right' }}>
                    <div style={{ fontSize: 10, color: '#9CA3AF' }}>Total Value</div>
                    <div style={{ fontSize: 14, fontWeight: 700, color: '#B85B7A', marginTop: 1 }}>
                      {sym} {pdcStats.next7DaysAmount.toLocaleString(undefined, { minimumFractionDigits: 2 })}
                    </div>
                  </div>
                </div>
                ...
                >
                  <div>
                    <div style={{ fontSize: 11, fontWeight: 700, color: '#DE8DA9', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Within 30 Days</div>
                    <div style={{ fontSize: 15, fontWeight: 700, color: 'var(--text-primary, #1F2937)', marginTop: 2 }}>
                      {pdcStats.next30DaysCount} {pdcStats.next30DaysCount === 1 ? 'Cheque' : 'Cheques'}
                    </div>
                  </div>
                  <div style={{ textAlign: 'right' }}>
                    <div style={{ fontSize: 10, color: '#9CA3AF' }}>Total Value</div>
                    <div style={{ fontSize: 14, fontWeight: 700, color: '#8F3D5B', marginTop: 1 }}>
                      {sym} {pdcStats.next30DaysAmount.toLocaleString(undefined, { minimumFractionDigits: 2 })}
                    </div>
                  </div>
                </div>
              </div>
