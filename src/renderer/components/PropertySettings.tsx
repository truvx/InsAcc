...
ALTER PUBLICATION supabase_realtime ADD TABLE public.app_sync_state;`}
        ...
        <div className="card" style={{ maxWidth: 600, marginTop: 24 }}>
          <div className="card-header">
            <span className="card-title">Data Backup & Restore</span>
          </div>
          <div className="card-body">
            <p style={{ fontSize: 13, color: '#6b7280', marginBottom: 16 }}>
            ...
            <div style={{ display: 'flex', gap: 12 }}>
              ...
              <label className="btn btn-secondary" style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8, cursor: 'pointer', margin: 0, padding: '8px 16px', borderRadius: '6px', fontSize: '13px', fontWeight: 500 }}>
                <input 
                  type="file" 
                  accept=".json" 
                  style={{ display: 'none' }} 
