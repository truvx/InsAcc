...
const renderActiveShape = (props: any) => {
  ...
  return (
    <g>
      <text x={cx} y={cy - 10} textAnchor="middle" fill="#1A1A2E" fontSize={18} fontWeight={700}>
        {payload.name}
      </text>
      <text x={cx} y={cy + 14} textAnchor="middle" fill="#6B7280" fontSize={13}>
        AED {value.toLocaleString()}
      </text>
      <text x={cx} y={cy + 32} textAnchor="middle" fill="#D4AF37" fontSize={13} fontWeight={600}>
        ...
        {data.map((item, i) => (
          <div
            ...
            style={{
              ...
              borderRadius: 20,
              cursor: 'pointer',
              background: activeIndex === i ? 'rgba(212,175,55,0.12)' : 'transparent',
              border: activeIndex === i ? '1px solid rgba(212,175,55,0.3)' : '1px solid transparent',
              transition: 'all 0.2s',
            }}
          >
