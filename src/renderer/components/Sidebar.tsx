...
function NavIcon({ id }: { id: string }) {
  const icons: Record<string, React.ReactNode> = {
    ...
    vendors: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2" /><circle cx="12" cy="7" r="4" /><path d="M16 3.13a4 4 0 0 1 0 7.75" /><line x1="22" y1="8" x2="22" y2="14" /><line x1="19" y1="11" x2="25" y2="11" /></svg>,
  ...
  return (
    <div className="sidebar">
      ...
      <div className="sidebar-footer">
        ...
        >
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" width="18" height="18" style={{ pointerEvents: 'none' }}>
